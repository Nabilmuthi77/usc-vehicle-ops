...
<head>
    ...
    <title>Atur Ulang Kata Sandi - USC Vehicle Ops</title>
</head>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; border: 1px solid #e8f6eb; box-shadow: 0 4px 20px rgba(16, 24, 40, 0.05); overflow: hidden;">
                    ...
                    <tr>
                        <td align="center" style="padding: 40px 40px 20px 40px; border-top: 4px solid #1da338;">
                            ...
                            <h2 style="margin: 0; font-size: 26px; font-weight: 700; color: #02081C; letter-spacing: -0.5px;">Atur Ulang Kata Sandi</h2>
                    ...
                    <tr>
                        <td style="padding: 20px 40px 40px 40px; font-size: 15px; line-height: 1.6; color: #475467;">
                            ...
                            <p style="margin: 0 0 20px 0;">Kami menerima permintaan untuk mengatur ulang kata sandi akun USC Vehicle Ops Anda. Nggak perlu khawatir, hal ini biasa terjadi kok! Silakan klik tombol hijau di bawah ini untuk membuat kata sandi baru Anda.</p>
                            
                            <div style="text-align: center; margin: 30px 0;">
                                <a href="{{ $url }}" style="display: inline-block; padding: 10px 24px; background: linear-gradient(to right, #1da338, #10b981); background-color: #1da338; color: #ffffff; text-decoration: none; font-size: 14px; font-weight: 600; border-radius: 8px; box-shadow: 0 4px 15px rgba(29, 163, 56, 0.25);">Buat Kata Sandi Baru</a>
                            </div>

                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 20px; border-radius: 4px; overflow: hidden;">
                                <tr>
                                    <td style="background-color:#e8f6eb;border-left:4px solid #1da338;padding:14px 16px">
                                        <p style="margin:0;color:#105a1f;font-size:13px;line-height:1.6">
                            ...
                            <p style="margin: 0 0 20px 0; font-size: 14px;">Jika Anda tidak pernah meminta pengaturan ulang kata sandi, Anda bisa mengabaikan email ini dengan aman.</p>
