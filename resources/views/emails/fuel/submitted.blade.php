...
<head>
    ...
    <title>Klaim BBM Menunggu Verifikasi - USC Vehicle Ops</title>
</head>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; border: 1px solid #e8f6eb; box-shadow: 0 4px 20px rgba(16, 24, 40, 0.05); overflow: hidden;">
                    ...
                    <tr>
                        <td align="center" style="padding: 40px 40px 20px 40px; border-top: 4px solid #1da338;">
                            ...
                            <h2 style="margin: 0; font-size: 26px; font-weight: 700; color: #02081C; letter-spacing: -0.5px;">Menunggu Verifikasi</h2>
                    ...
                    <tr>
                        <td style="padding: 20px 40px 40px 40px; font-size: 15px; line-height: 1.6; color: #475467;">
                            ...
                            <p style="margin: 0 0 20px 0;">Ada pengajuan klaim BBM baru yang menunggu verifikasi Anda. Berikut adalah rincian pengajuannya:</p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 30px; border-radius: 8px; border: 1px solid #e2e8f0; border-collapse: collapse;">
                                <tr>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; font-weight: 600; color: #02081C; width: 40%;">Pemohon</td>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; color: #475467;">{{ $transaction->claimant?->name ?? '-' }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; font-weight: 600; color: #02081C;">SPBU</td>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; color: #475467;">{{ $transaction->station_name }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; color: #475467;">{{ $transaction->transaction_datetime->format('d-m-Y H:i') }}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; font-weight: 600; color: #02081C;">Jumlah</td>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; color: #475467;">{{ number_format((float) $transaction->liters, 2, ',', '.') }} liter</td>
                                </tr>
                                <tr>
                                    <td style="padding: 12px 16px; font-weight: 600; color: #02081C;">Total Nominal</td>
                                    <td style="padding: 12px 16px; color: #475467;">Rp {{ number_format((float) $transaction->total_cost, 0, ',', '.') }}</td>
                                </tr>
                            </table>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 20px; border-radius: 4px; overflow: hidden;">
                                <tr>
                                    <td style="background-color:#fffbeb;border-left:4px solid #f59e0b;padding:14px 16px">
                                        <p style="margin:0;color:#92400e;font-size:13px;line-height:1.6">
                                            <strong>Transaksi ini ditandai anomali:</strong><br>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 20px; border-radius: 4px; overflow: hidden;">
                                <tr>
                                    <td style="background-color:#fef2f2;border-left:4px solid #ef4444;padding:14px 16px">
                                        <p style="margin:0;color:#991b1b;font-size:13px;line-height:1.6">
                                            <strong>Klaim Terlambat:</strong> Klaim melewati batas waktu pengajuan dan memerlukan persetujuan khusus.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style="text-align: center; margin: 30px 0;">
                                <a href="{{ $url }}" style="display: inline-block; padding: 10px 24px; background: linear-gradient(to right, #1da338, #10b981); background-color: #1da338; color: #ffffff; text-decoration: none; font-size: 14px; font-weight: 600; border-radius: 8px; box-shadow: 0 4px 15px rgba(29, 163, 56, 0.25);">Proses Verifikasi</a>
                            </div>
