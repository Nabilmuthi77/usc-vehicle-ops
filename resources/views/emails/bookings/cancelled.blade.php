...
<head>
    ...
    <title>Peminjaman Dibatalkan - USC Vehicle Ops</title>
</head>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; border: 1px solid #e8f6eb; box-shadow: 0 4px 20px rgba(16, 24, 40, 0.05); overflow: hidden;">
                    ...
                    <tr>
                        <td align="center" style="padding: 40px 40px 20px 40px; border-top: 4px solid #1da338;">
                            ...
                            <h2 style="margin: 0; font-size: 26px; font-weight: 700; color: #02081C; letter-spacing: -0.5px;">Peminjaman Dibatalkan</h2>
                    ...
                    <tr>
                        <td style="padding: 20px 40px 40px 40px; font-size: 15px; line-height: 1.6; color: #475467;">
                            ...
                            <p style="margin: 0 0 20px 0;">Pengajuan peminjaman kendaraan berikut telah dibatalkan oleh pemohon:</p>
                            ...
                            <!-- Pink Alert for Cancellation -->
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 20px; border-radius: 4px; overflow: hidden;">
                                <tr>
                                    <td style="background-color:#fdf2f8;border-left:4px solid #ec4899;padding:14px 16px">
                                        <p style="margin:0;color:#9d174d;font-size:13px;line-height:1.6">
                                            <strong>Dibatalkan:</strong> Pengajuan peminjaman ini telah dibatalkan.
                                            @if(filled($booking->cancellation_reason))
                                                <br><strong>Catatan Pembatalan:</strong> {{ $booking->cancellation_reason }}
                                            @endif
                                        </p>
                                    </td>
                                </tr>
                            ...
                            <div style="text-align: center; margin: 30px 0;">
                                <a href="{{ $url }}" style="display: inline-block; padding: 10px 24px; background: linear-gradient(to right, #1da338, #10b981); background-color: #1da338; color: #ffffff; text-decoration: none; font-size: 14px; font-weight: 600; border-radius: 8px; box-shadow: 0 4px 15px rgba(29, 163, 56, 0.25);">Lihat Detail</a>
                            </div>
