...
<head>
    ...
    <title>Peminjaman Disetujui - USC Vehicle Ops</title>
</head>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; border: 1px solid #e8f6eb; box-shadow: 0 4px 20px rgba(16, 24, 40, 0.05); overflow: hidden;">
                    ...
                    <tr>
                        <td align="center" style="padding: 40px 40px 20px 40px; border-top: 4px solid #1da338;">
                            ...
                            <h2 style="margin: 0; font-size: 26px; font-weight: 700; color: #02081C; letter-spacing: -0.5px;">Peminjaman Disetujui</h2>
                    ...
                    <tr>
                        <td style="padding: 20px 40px 40px 40px; font-size: 15px; line-height: 1.6; color: #475467;">
                            ...
                            <p style="margin: 0 0 20px 0;">Pengajuan peminjaman kendaraan Anda telah <strong>disetujui</strong>. Berikut rincian peminjaman Anda:</p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 30px; border-radius: 8px; border: 1px solid #e2e8f0; border-collapse: collapse;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; color: #475467;">{{ $booking->vehicle?->full_name ?? '-' }}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; font-weight: 600; color: #02081C;">Nomor Polisi</td>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; color: #475467;">{{ $booking->vehicle?->plate_number ?? '-' }}</td>
                                </tr>
                                @if($booking->driver !== null)
                                <tr>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; font-weight: 600; color: #02081C;">Driver</td>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; color: #475467;">{{ $booking->driver->name }}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; font-weight: 600; color: #02081C;">Kontak Driver</td>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; color: #475467;">{{ $booking->driver->phone ?: '-' }}</td>
                                </tr>
                                @endif
                            </table>
                                ...
                                <tr>
                                    <td style="background-color:#eff6ff;border-left:4px solid #3b82f6;padding:14px 16px">
                                        <p style="margin:0;color:#1e40af;font-size:13px;line-height:1.6">
                                            <strong>Self Drive:</strong> Tidak ada driver yang ditugaskan — kendaraan dikemudikan sendiri dan Anda menjadi penanggung jawab kendaraan.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            @if(filled($booking->assignment_note))
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 20px; border-radius: 4px; overflow: hidden;">
                                <tr>
                                    <td style="background-color:#fefce8;border-left:4px solid #eab308;padding:14px 16px">
                                        <p style="margin:0;color:#854d0e;font-size:13px;line-height:1.6">
                                            <strong>Catatan Admin GA:</strong> {{ $booking->assignment_note }}
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style="text-align: center; margin: 30px 0;">
                                <a href="{{ $url }}" style="display: inline-block; padding: 10px 24px; background: linear-gradient(to right, #1da338, #10b981); background-color: #1da338; color: #ffffff; text-decoration: none; font-size: 14px; font-weight: 600; border-radius: 8px; box-shadow: 0 4px 15px rgba(29, 163, 56, 0.25);">Lihat Detail Peminjaman</a>
                            </div>
