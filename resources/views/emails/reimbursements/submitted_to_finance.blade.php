...
<head>
    ...
    <title>Batch Reimbursement Masuk - USC Vehicle Ops</title>
</head>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; border: 1px solid #e8f6eb; box-shadow: 0 4px 20px rgba(16, 24, 40, 0.05); overflow: hidden;">
                    ...
                    <tr>
                        <td align="center" style="padding: 40px 40px 20px 40px; border-top: 4px solid #1da338;">
                            ...
                            <div style="display: inline-block; padding: 6px 14px; background-color: #e8f6eb; color: #1da338; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 1.5px; border-radius: 20px; margin-bottom: 16px; border: 1px solid #c8eccf;">
                                Batch Reimbursement Baru
                            </div>
                            <h2 style="margin: 0; font-size: 26px; font-weight: 700; color: #02081C; letter-spacing: -0.5px;">Memerlukan Pembayaran</h2>
                    ...
                    <tr>
                        <td style="padding: 20px 40px 40px 40px; font-size: 15px; line-height: 1.6; color: #475467;">
                            <p style="margin: 0 0 20px 0;">Halo <strong>Tim Finance</strong>,</p>
                            <p style="margin: 0 0 20px 0;">Sebuah Batch Reimbursement baru telah diserahkan oleh tim GA dan memerlukan proses pembayaran Anda. Berikut adalah rinciannya:</p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 30px; border-radius: 8px; border: 1px solid #e2e8f0; border-collapse: collapse;">
                                <tr>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; font-weight: 600; color: #02081C; width: 40%;">No. Batch</td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; color: #475467;">{{ $batch->claimant?->name ?? '-' }}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; font-weight: 600; color: #02081C;">Periode</td>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; color: #475467;">
                                        {{ \Carbon\Carbon::parse($batch->period_start)->format('d/m/Y') }} - {{ \Carbon\Carbon::parse($batch->period_end)->format('d/m/Y') }}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 12px 16px; color: #475467; font-weight: 600;">Rp {{ number_format((float) $batch->total_amount, 0, ',', '.') }}</td>
                                </tr>
                            </table>

                            <div style="text-align: center; margin: 30px 0;">
                                <a href="{{ $url }}" style="display: inline-block; padding: 10px 24px; background: linear-gradient(to right, #1da338, #10b981); background-color: #1da338; color: #ffffff; text-decoration: none; font-size: 14px; font-weight: 600; border-radius: 8px; box-shadow: 0 4px 15px rgba(29, 163, 56, 0.25);">Proses Pembayaran</a>
                            </div>
